...
// Create page object
$tb_penelitian_edit = new tb_penelitian_edit();

// Run the page
$tb_penelitian_edit->run();
...
$tb_penelitian_edit->Page_Render();
?>
...
var ftb_penelitianedit = currentForm = new ew.Form("ftb_penelitianedit", "edit");

// Validate form
ftb_penelitianedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tb_penelitian_edit->id_penelitian->Required) { ?>
			elm = this.getElements("x" + infix + "_id_penelitian");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $tb_penelitian->id_penelitian->caption(), $tb_penelitian->id_penelitian->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($tb_penelitian_edit->NIDN->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_penelitian_edit->anggota1->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_penelitian_edit->anggota2->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_penelitian_edit->id_jurusan->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_penelitian_edit->judul->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_penelitian_edit->biaya->Required) { ?>
		...
		<?php if ($tb_penelitian_edit->tahun->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_penelitian_edit->LP->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_penelitian_edit->LK->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_penelitian_edit->output->Required) { ?>
...
ftb_penelitianedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftb_penelitianedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftb_penelitianedit.lists["x_NIDN"] = <?php echo $tb_penelitian_edit->NIDN->Lookup->toClientList() ?>;
ftb_penelitianedit.lists["x_NIDN"].options = <?php echo JsonEncode($tb_penelitian_edit->NIDN->lookupOptions()) ?>;
ftb_penelitianedit.autoSuggests["x_NIDN"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
ftb_penelitianedit.lists["x_anggota1"] = <?php echo $tb_penelitian_edit->anggota1->Lookup->toClientList() ?>;
ftb_penelitianedit.lists["x_anggota1"].options = <?php echo JsonEncode($tb_penelitian_edit->anggota1->lookupOptions()) ?>;
ftb_penelitianedit.autoSuggests["x_anggota1"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
ftb_penelitianedit.lists["x_anggota2"] = <?php echo $tb_penelitian_edit->anggota2->Lookup->toClientList() ?>;
ftb_penelitianedit.lists["x_anggota2"].options = <?php echo JsonEncode($tb_penelitian_edit->anggota2->lookupOptions()) ?>;
ftb_penelitianedit.autoSuggests["x_anggota2"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
ftb_penelitianedit.lists["x_id_jurusan"] = <?php echo $tb_penelitian_edit->id_jurusan->Lookup->toClientList() ?>;
ftb_penelitianedit.lists["x_id_jurusan"].options = <?php echo JsonEncode($tb_penelitian_edit->id_jurusan->options(FALSE, TRUE)) ?>;
...
<?php $tb_penelitian_edit->showPageHeader(); ?>
<?php
$tb_penelitian_edit->showMessage();
?>
<form name="ftb_penelitianedit" id="ftb_penelitianedit" class="<?php echo $tb_penelitian_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($tb_penelitian_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tb_penelitian_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_penelitian">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$tb_penelitian_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($tb_penelitian->id_penelitian->Visible) { // id_penelitian ?>
	<div id="r_id_penelitian" class="form-group row">
		<label id="elh_tb_penelitian_id_penelitian" class="<?php echo $tb_penelitian_edit->LeftColumnClass ?>"><?php echo $tb_penelitian->id_penelitian->caption() ?><?php echo ($tb_penelitian->id_penelitian->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_penelitian_edit->RightColumnClass ?>"><div<?php echo $tb_penelitian->id_penelitian->cellAttributes() ?>>
<span id="el_tb_penelitian_id_penelitian">
<span<?php echo $tb_penelitian->id_penelitian->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($tb_penelitian->id_penelitian->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="tb_penelitian" data-field="x_id_penelitian" name="x_id_penelitian" id="x_id_penelitian" value="<?php echo HtmlEncode($tb_penelitian->id_penelitian->CurrentValue) ?>">
<?php echo $tb_penelitian->id_penelitian->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($tb_penelitian->NIDN->Visible) { // NIDN ?>
	<div id="r_NIDN" class="form-group row">
		<label id="elh_tb_penelitian_NIDN" class="<?php echo $tb_penelitian_edit->LeftColumnClass ?>"><?php echo $tb_penelitian->NIDN->caption() ?><?php echo ($tb_penelitian->NIDN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_penelitian_edit->RightColumnClass ?>"><div<?php echo $tb_penelitian->NIDN->cellAttributes() ?>>
<?php if (!$Security->isAdmin() && $Security->isLoggedIn() && !$tb_penelitian->userIDAllow("edit")) { // Non system admin ?>
...
<script>
ftb_penelitianedit.createAutoSuggest({"id":"x_NIDN","forceSelect":false});
</script>
...
<?php if ($tb_penelitian->anggota1->Visible) { // anggota1 ?>
	<div id="r_anggota1" class="form-group row">
		<label id="elh_tb_penelitian_anggota1" class="<?php echo $tb_penelitian_edit->LeftColumnClass ?>"><?php echo $tb_penelitian->anggota1->caption() ?><?php echo ($tb_penelitian->anggota1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_penelitian_edit->RightColumnClass ?>"><div<?php echo $tb_penelitian->anggota1->cellAttributes() ?>>
...
<script>
ftb_penelitianedit.createAutoSuggest({"id":"x_anggota1","forceSelect":false});
</script>
...
<?php if ($tb_penelitian->anggota2->Visible) { // anggota2 ?>
	<div id="r_anggota2" class="form-group row">
		<label id="elh_tb_penelitian_anggota2" class="<?php echo $tb_penelitian_edit->LeftColumnClass ?>"><?php echo $tb_penelitian->anggota2->caption() ?><?php echo ($tb_penelitian->anggota2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_penelitian_edit->RightColumnClass ?>"><div<?php echo $tb_penelitian->anggota2->cellAttributes() ?>>
...
<script>
ftb_penelitianedit.createAutoSuggest({"id":"x_anggota2","forceSelect":false});
</script>
...
<?php if ($tb_penelitian->id_jurusan->Visible) { // id_jurusan ?>
	<div id="r_id_jurusan" class="form-group row">
		<label id="elh_tb_penelitian_id_jurusan" for="x_id_jurusan" class="<?php echo $tb_penelitian_edit->LeftColumnClass ?>"><?php echo $tb_penelitian->id_jurusan->caption() ?><?php echo ($tb_penelitian->id_jurusan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_penelitian_edit->RightColumnClass ?>"><div<?php echo $tb_penelitian->id_jurusan->cellAttributes() ?>>
...
<?php if ($tb_penelitian->judul->Visible) { // judul ?>
	<div id="r_judul" class="form-group row">
		<label id="elh_tb_penelitian_judul" for="x_judul" class="<?php echo $tb_penelitian_edit->LeftColumnClass ?>"><?php echo $tb_penelitian->judul->caption() ?><?php echo ($tb_penelitian->judul->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_penelitian_edit->RightColumnClass ?>"><div<?php echo $tb_penelitian->judul->cellAttributes() ?>>
...
<?php if ($tb_penelitian->biaya->Visible) { // biaya ?>
	<div id="r_biaya" class="form-group row">
		<label id="elh_tb_penelitian_biaya" for="x_biaya" class="<?php echo $tb_penelitian_edit->LeftColumnClass ?>"><?php echo $tb_penelitian->biaya->caption() ?><?php echo ($tb_penelitian->biaya->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_penelitian_edit->RightColumnClass ?>"><div<?php echo $tb_penelitian->biaya->cellAttributes() ?>>
...
<?php if ($tb_penelitian->tahun->Visible) { // tahun ?>
	<div id="r_tahun" class="form-group row">
		<label id="elh_tb_penelitian_tahun" for="x_tahun" class="<?php echo $tb_penelitian_edit->LeftColumnClass ?>"><?php echo $tb_penelitian->tahun->caption() ?><?php echo ($tb_penelitian->tahun->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_penelitian_edit->RightColumnClass ?>"><div<?php echo $tb_penelitian->tahun->cellAttributes() ?>>
...
<?php if ($tb_penelitian->LP->Visible) { // LP ?>
	<div id="r_LP" class="form-group row">
		<label id="elh_tb_penelitian_LP" class="<?php echo $tb_penelitian_edit->LeftColumnClass ?>"><?php echo $tb_penelitian->LP->caption() ?><?php echo ($tb_penelitian->LP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_penelitian_edit->RightColumnClass ?>"><div<?php echo $tb_penelitian->LP->cellAttributes() ?>>
...
<?php if ($tb_penelitian->LK->Visible) { // LK ?>
	<div id="r_LK" class="form-group row">
		<label id="elh_tb_penelitian_LK" class="<?php echo $tb_penelitian_edit->LeftColumnClass ?>"><?php echo $tb_penelitian->LK->caption() ?><?php echo ($tb_penelitian->LK->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_penelitian_edit->RightColumnClass ?>"><div<?php echo $tb_penelitian->LK->cellAttributes() ?>>
...
<?php if ($tb_penelitian->output->Visible) { // output ?>
	<div id="r_output" class="form-group row">
		<label id="elh_tb_penelitian_output" class="<?php echo $tb_penelitian_edit->LeftColumnClass ?>"><?php echo $tb_penelitian->output->caption() ?><?php echo ($tb_penelitian->output->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_penelitian_edit->RightColumnClass ?>"><div<?php echo $tb_penelitian->output->cellAttributes() ?>>
...
<?php if (!$tb_penelitian_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $tb_penelitian_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $tb_penelitian_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$tb_penelitian_edit->showPageFooter();
if (DEBUG_ENABLED)
