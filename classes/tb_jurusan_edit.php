 ...
 * Page class
 */
class tb_jurusan_edit extends tb_jurusan
{
	...
	// Page object name
	public $PageObjName = "tb_jurusan_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_id_jurusan")) {
				$this->id_jurusan->setFormValue($CurrentForm->getValue("x_id_jurusan"));
			}
		} else {
