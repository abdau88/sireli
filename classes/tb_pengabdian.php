...
/**
 * Table class for tb_pengabdian
 */
class tb_pengabdian extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tb_pengabdian';
		$this->TableName = 'tb_pengabdian';
		...
		// id_pengabdian
		$this->id_pengabdian = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_id_pengabdian', 'id_pengabdian', '`id_pengabdian`', '`id_pengabdian`', 3, -1, FALSE, '`id_pengabdian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// NIDN
		$this->NIDN = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_NIDN', 'NIDN', '`NIDN`', '`NIDN`', 200, -1, FALSE, '`NIDN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// anggota1
		$this->anggota1 = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_anggota1', 'anggota1', '`anggota1`', '`anggota1`', 200, -1, FALSE, '`anggota1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// anggota2
		$this->anggota2 = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_anggota2', 'anggota2', '`anggota2`', '`anggota2`', 200, -1, FALSE, '`anggota2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// anggota3
		$this->anggota3 = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_anggota3', 'anggota3', '`anggota3`', '`anggota3`', 200, -1, FALSE, '`anggota3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->anggota3->Sortable = TRUE; // Allow sort
		$this->anggota3->Lookup = new Lookup('anggota3', 'tb_dosen', FALSE, 'Nama_Dosen', ["Nama_Dosen","","",""], [], [], [], [], [], [], '', '');
		$this->fields['anggota3'] = &$this->anggota3;

		// anggota4
		$this->anggota4 = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_anggota4', 'anggota4', '`anggota4`', '`anggota4`', 200, -1, FALSE, '`anggota4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->anggota4->Sortable = TRUE; // Allow sort
		$this->anggota4->Lookup = new Lookup('anggota4', 'tb_dosen', FALSE, 'Nama_Dosen', ["Nama_Dosen","","",""], [], [], [], [], [], [], '', '');
		$this->fields['anggota4'] = &$this->anggota4;

		// judul
		$this->judul = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_judul', 'judul', '`judul`', '`judul`', 200, -1, FALSE, '`judul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->judul->Sortable = TRUE; // Allow sort
		$this->fields['judul'] = &$this->judul;

		// biaya
		$this->biaya = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_biaya', 'biaya', '`biaya`', '`biaya`', 3, -1, FALSE, '`biaya`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun
		$this->tahun = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 200, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tahun->Sortable = TRUE; // Allow sort
		$this->fields['tahun'] = &$this->tahun;

		// status
		$this->status = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_status', 'status', '`status`', '`status`', 200, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->status->PleaseSelectText = $Language->phrase("PleaseSelect"); // PleaseSelect text
		$this->status->Lookup = new Lookup('status', 'tb_pengabdian', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->status->OptionCount = 2;
		$this->fields['status'] = &$this->status;

		// LP2
		$this->LP2 = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_LP2', 'LP2', '`LP2`', '`LP2`', 200, -1, TRUE, '`LP2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->LP2->Sortable = TRUE; // Allow sort
		$this->fields['LP2'] = &$this->LP2;

		// LK
		$this->LK = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_LK', 'LK', '`LK`', '`LK`', 200, -1, TRUE, '`LK`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->LK->Sortable = TRUE; // Allow sort
		$this->fields['LK'] = &$this->LK;

		// output
		$this->output = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_output', 'output', '`output`', '`output`', 200, -1, TRUE, '`output`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->output->Sortable = TRUE; // Allow sort
		$this->fields['output'] = &$this->output;

		// chr
		$this->chr = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_chr', 'chr', '`chr`', '`chr`', 200, -1, TRUE, '`chr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->chr->Sortable = FALSE; // Allow sort
		$this->fields['chr'] = &$this->chr;

		// surat_tugas
		$this->surat_tugas = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_surat_tugas', 'surat_tugas', '`surat_tugas`', '`surat_tugas`', 200, -1, TRUE, '`surat_tugas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->surat_tugas->Sortable = FALSE; // Allow sort
		$this->fields['surat_tugas'] = &$this->surat_tugas;

		// sk
		$this->sk = new DbField('tb_pengabdian', 'tb_pengabdian', 'x_sk', 'sk', '`sk`', '`sk`', 200, -1, TRUE, '`sk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->sk->Sortable = FALSE; // Allow sort
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "tb_pengabdianedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tb_pengabdianadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tb_pengabdianview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tb_pengabdianview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "tb_pengabdianadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tb_pengabdianadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tb_pengabdianedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tb_pengabdianadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tb_pengabdiandelete.php", $this->getUrlParm());
	}
	...
	public function getUserIDSubquery(&$fld, &$masterfld)
	{
		...
		$wrk = "";
		$sql = "SELECT " . $masterfld->Expression . " FROM `tb_pengabdian`";
