...
/**
 * Table class for tb_penelitian2
 */
class tb_penelitian2 extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tb_penelitian2';
		$this->TableName = 'tb_penelitian2';
		...
		// id_penelitian
		$this->id_penelitian = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_id_penelitian', 'id_penelitian', '`id_penelitian`', '`id_penelitian`', 3, -1, FALSE, '`id_penelitian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// NIDN
		$this->NIDN = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_NIDN', 'NIDN', '`NIDN`', '`NIDN`', 200, -1, FALSE, '`NIDN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// anggota1
		$this->anggota1 = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_anggota1', 'anggota1', '`anggota1`', '`anggota1`', 200, -1, FALSE, '`anggota1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->anggota1->Sortable = TRUE; // Allow sort
		$this->fields['anggota1'] = &$this->anggota1;

		// anggota2
		$this->anggota2 = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_anggota2', 'anggota2', '`anggota2`', '`anggota2`', 200, -1, FALSE, '`anggota2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->anggota2->Sortable = TRUE; // Allow sort
		$this->fields['anggota2'] = &$this->anggota2;

		// id_jurusan
		$this->id_jurusan = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_id_jurusan', 'id_jurusan', '`id_jurusan`', '`id_jurusan`', 3, -1, FALSE, '`id_jurusan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// judul
		$this->judul = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_judul', 'judul', '`judul`', '`judul`', 200, -1, FALSE, '`judul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->judul->Sortable = TRUE; // Allow sort
		$this->fields['judul'] = &$this->judul;

		// biaya
		$this->biaya = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_biaya', 'biaya', '`biaya`', '`biaya`', 3, -1, FALSE, '`biaya`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun
		$this->tahun = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 200, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tahun->Sortable = TRUE; // Allow sort
		$this->fields['tahun'] = &$this->tahun;

		// status
		$this->status = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_status', 'status', '`status`', '`status`', 200, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->status->PleaseSelectText = $Language->phrase("PleaseSelect"); // PleaseSelect text
		$this->status->Lookup = new Lookup('status', 'tb_penelitian2', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->status->OptionCount = 2;
		$this->fields['status'] = &$this->status;

		// LP
		$this->LP = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_LP', 'LP', '`LP`', '`LP`', 200, -1, TRUE, '`LP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->LP->Sortable = TRUE; // Allow sort
		$this->fields['LP'] = &$this->LP;

		// LK
		$this->LK = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_LK', 'LK', '`LK`', '`LK`', 200, -1, TRUE, '`LK`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->LK->Sortable = TRUE; // Allow sort
		$this->fields['LK'] = &$this->LK;

		// output
		$this->output = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_output', 'output', '`output`', '`output`', 200, -1, TRUE, '`output`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->output->Sortable = TRUE; // Allow sort
		$this->fields['output'] = &$this->output;

		// chr
		$this->chr = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_chr', 'chr', '`chr`', '`chr`', 200, -1, TRUE, '`chr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->chr->Sortable = TRUE; // Allow sort
		$this->fields['chr'] = &$this->chr;

		// surat_tugas
		$this->surat_tugas = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_surat_tugas', 'surat_tugas', '`surat_tugas`', '`surat_tugas`', 200, -1, TRUE, '`surat_tugas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->surat_tugas->Sortable = TRUE; // Allow sort
		$this->fields['surat_tugas'] = &$this->surat_tugas;

		// sk
		$this->sk = new DbField('tb_penelitian2', 'tb_penelitian2', 'x_sk', 'sk', '`sk`', '`sk`', 200, -1, TRUE, '`sk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "tb_penelitian2edit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tb_penelitian2add.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tb_penelitian2view.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tb_penelitian2view.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "tb_penelitian2add.php?" . $this->getUrlParm($parm);
		else
			$url = "tb_penelitian2add.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tb_penelitian2edit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tb_penelitian2add.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tb_penelitian2delete.php", $this->getUrlParm());
	}
