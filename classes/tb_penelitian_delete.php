 ...
 * Page class
 */
class tb_penelitian_delete extends tb_penelitian
{
	...
	// Page object name
	public $PageObjName = "tb_penelitian_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tb_penelitianlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($rs = LoadRecordset($sql, $conn)) {
			...
			$rs->close();
			if (!$res) {
				$this->terminate("tb_penelitianlist.php"); // Return to list
				return;
			}
		}
