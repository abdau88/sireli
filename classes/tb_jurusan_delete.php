 ...
 * Page class
 */
class tb_jurusan_delete extends tb_jurusan
{
	...
	// Page object name
	public $PageObjName = "tb_jurusan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tb_jurusanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tb_jurusanlist.php"); // Return to list
			}
		}
	}
