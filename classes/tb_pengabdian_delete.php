 ...
 * Page class
 */
class tb_pengabdian_delete extends tb_pengabdian
{
	...
	// Page object name
	public $PageObjName = "tb_pengabdian_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tb_pengabdianlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($rs = LoadRecordset($sql, $conn)) {
			...
			$rs->close();
			if (!$res) {
				$this->terminate("tb_pengabdianlist.php"); // Return to list
				return;
			}
		}
