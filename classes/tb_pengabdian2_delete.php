 ...
 * Page class
 */
class tb_pengabdian2_delete extends tb_pengabdian2
{
	...
	// Page object name
	public $PageObjName = "tb_pengabdian2_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tb_pengabdian2list.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tb_pengabdian2list.php"); // Return to list
			}
		}
	}
