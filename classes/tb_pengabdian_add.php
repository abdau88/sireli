 ...
 * Page class
 */
class tb_pengabdian_add extends tb_pengabdian
{
	...
	// Page object name
	public $PageObjName = "tb_pengabdian_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "tb_pengabdianview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// anggota3
		$this->anggota3->setDbValueDef($rsnew, $this->anggota3->CurrentValue, NULL, FALSE);

		// anggota4
		$this->anggota4->setDbValueDef($rsnew, $this->anggota4->CurrentValue, NULL, FALSE);
		...
		if ($this->LP2->Visible && !$this->LP2->Upload->KeepFile) {
			$this->LP2->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->LP2->Visible && !$this->LP2->Upload->KeepFile) {
			...
			if (!EmptyValue($this->LP2->Upload->FileName)) {
				...
				$this->LP2->setDbValueDef($rsnew, $this->LP2->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->LK->Visible && !$this->LK->Upload->KeepFile) {
