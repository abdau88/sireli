 ...
 * Page class
 */
class tb_penelitian2_delete extends tb_penelitian2
{
	...
	// Page object name
	public $PageObjName = "tb_penelitian2_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tb_penelitian2list.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tb_penelitian2list.php"); // Return to list
			}
		}
	}
