...
/**
 * Table class for tb_pengabdian3
 */
class tb_pengabdian3 extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tb_pengabdian3';
		$this->TableName = 'tb_pengabdian3';
		...
		// id_pengabdian
		$this->id_pengabdian = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_id_pengabdian', 'id_pengabdian', '`id_pengabdian`', '`id_pengabdian`', 3, -1, FALSE, '`id_pengabdian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// NPAK_NIP
		$this->NPAK_NIP = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_NPAK_NIP', 'NPAK_NIP', '`NPAK_NIP`', '`NPAK_NIP`', 200, -1, FALSE, '`NPAK_NIP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NPAK_NIP->Sortable = TRUE; // Allow sort
		$this->NPAK_NIP->Lookup = new Lookup('NPAK_NIP', 'tb_dosen', FALSE, 'NPAK_NIP', ["Nama_Dosen","","",""], [], [], [], [], [], [], '', '');
		$this->fields['NPAK_NIP'] = &$this->NPAK_NIP;

		// anggota1
		$this->anggota1 = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_anggota1', 'anggota1', '`anggota1`', '`anggota1`', 200, -1, FALSE, '`anggota1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->anggota1->Sortable = TRUE; // Allow sort
		$this->fields['anggota1'] = &$this->anggota1;

		// anggota2
		$this->anggota2 = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_anggota2', 'anggota2', '`anggota2`', '`anggota2`', 200, -1, FALSE, '`anggota2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->anggota2->Sortable = TRUE; // Allow sort
		$this->fields['anggota2'] = &$this->anggota2;

		// anggota3
		$this->anggota3 = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_anggota3', 'anggota3', '`anggota3`', '`anggota3`', 200, -1, FALSE, '`anggota3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->anggota3->Sortable = TRUE; // Allow sort
		$this->fields['anggota3'] = &$this->anggota3;

		// anggota4
		$this->anggota4 = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_anggota4', 'anggota4', '`anggota4`', '`anggota4`', 200, -1, FALSE, '`anggota4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->anggota4->Sortable = TRUE; // Allow sort
		$this->fields['anggota4'] = &$this->anggota4;

		// judul
		$this->judul = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_judul', 'judul', '`judul`', '`judul`', 200, -1, FALSE, '`judul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->judul->Sortable = TRUE; // Allow sort
		$this->fields['judul'] = &$this->judul;

		// biaya
		$this->biaya = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_biaya', 'biaya', '`biaya`', '`biaya`', 3, -1, FALSE, '`biaya`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun
		$this->tahun = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 200, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tahun->Sortable = TRUE; // Allow sort
		$this->fields['tahun'] = &$this->tahun;

		// status
		$this->status = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_status', 'status', '`status`', '`status`', 200, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->status->PleaseSelectText = $Language->phrase("PleaseSelect"); // PleaseSelect text
		$this->status->Lookup = new Lookup('status', 'tb_pengabdian3', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->status->OptionCount = 2;
		$this->fields['status'] = &$this->status;

		// LP
		$this->LP = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_LP', 'LP', '`LP`', '`LP`', 200, -1, FALSE, '`LP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LP->Sortable = TRUE; // Allow sort
		$this->fields['LP'] = &$this->LP;

		// LK
		$this->LK = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_LK', 'LK', '`LK`', '`LK`', 200, -1, FALSE, '`LK`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LK->Sortable = TRUE; // Allow sort
		$this->fields['LK'] = &$this->LK;

		// output
		$this->output = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_output', 'output', '`output`', '`output`', 200, -1, FALSE, '`output`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->output->Sortable = TRUE; // Allow sort
		$this->fields['output'] = &$this->output;

		// chr
		$this->chr = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_chr', 'chr', '`chr`', '`chr`', 200, -1, TRUE, '`chr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->chr->Sortable = TRUE; // Allow sort
		$this->fields['chr'] = &$this->chr;

		// surat_tugas
		$this->surat_tugas = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_surat_tugas', 'surat_tugas', '`surat_tugas`', '`surat_tugas`', 200, -1, FALSE, '`surat_tugas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->surat_tugas->Sortable = TRUE; // Allow sort
		$this->fields['surat_tugas'] = &$this->surat_tugas;

		// sk
		$this->sk = new DbField('tb_pengabdian3', 'tb_pengabdian3', 'x_sk', 'sk', '`sk`', '`sk`', 200, -1, FALSE, '`sk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		global $Language;
		if ($pageName == "tb_pengabdian3view.php")
			return $Language->phrase("View");
		elseif ($pageName == "tb_pengabdian3edit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tb_pengabdian3add.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("tb_pengabdian3view.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tb_pengabdian3view.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "tb_pengabdian3add.php?" . $this->getUrlParm($parm);
		else
			$url = "tb_pengabdian3add.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tb_pengabdian3edit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tb_pengabdian3add.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tb_pengabdian3delete.php", $this->getUrlParm());
	}
