 ...
 * Page class
 */
class tb_jurusan_add extends tb_jurusan
{
	...
	// Page object name
	public $PageObjName = "tb_jurusan_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_jurusan") !== NULL) {
				...
				$this->setKey("id_jurusan", $this->id_jurusan->CurrentValue); // Set up key
			} else {
				$this->setKey("id_jurusan", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("tb_jurusanlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "tb_jurusanlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "tb_jurusanview.php")
