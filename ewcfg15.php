...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'w2eBzV7gwy98tg5Z'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/project2.css"); // Project stylesheet file name
...
$PROJECT_ID = "{6F3C73F1-7D22-4D79-93D1-87C709939CCD}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sireli", "qs" => "`", "qe" => "`");
$CONNECTIONS[0] = &$CONNECTIONS["DB"];
$CONNECTIONS["sireli1"] = array("conn" => NULL, "id" => "sireli1", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sireli", "qs" => "`", "qe" => "`", "new" => TRUE);
$CONNECTIONS[1] = &$CONNECTIONS["sireli1"];
$CONNECTIONS["sireli2"] = array("conn" => NULL, "id" => "sireli2", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sireli", "qs" => "`", "qe" => "`", "new" => TRUE);
$CONNECTIONS[2] = &$CONNECTIONS["sireli2"];
$CONNECTIONS["sireli3"] = array("conn" => NULL, "id" => "sireli3", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sireli", "qs" => "`", "qe" => "`", "new" => TRUE);
$CONNECTIONS[3] = &$CONNECTIONS["sireli3"];
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "tb_dosen");
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "NIDN");
define(PROJECT_NAMESPACE . "LOGIN_PASSWORD_FIELD_NAME", "password");
define(PROJECT_NAMESPACE . "USER_ID_FIELD_NAME", "NIDN");
define(PROJECT_NAMESPACE . "USER_LEVEL_FIELD_NAME", "userlevel");
define(PROJECT_NAMESPACE . "USER_PROFILE_FIELD_NAME", "");
define(PROJECT_NAMESPACE . "REGISTER_ACTIVATE_FIELD_NAME", "activated");
define(PROJECT_NAMESPACE . "USER_EMAIL_FIELD_NAME", "email");

// User table filters
define(PROJECT_NAMESPACE . "USER_TABLE_DBID", "DB");
define(PROJECT_NAMESPACE . "USER_TABLE", "`tb_dosen`");
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(`NIDN` = '%u')");
define(PROJECT_NAMESPACE . "USER_ID_FILTER", "(`NIDN` = '%u')");
define(PROJECT_NAMESPACE . "USER_EMAIL_FILTER", "(`email` = '%e')");
define(PROJECT_NAMESPACE . "USER_ACTIVATE_FILTER", "(`activated` = 1)");
...
define(PROJECT_NAMESPACE . "SMTP_SERVER_USERNAME", "abdau@pnc.ac.id"); // SMTP server user name
define(PROJECT_NAMESPACE . "SMTP_SERVER_PASSWORD", "lisa020816"); // SMTP server password
define(PROJECT_NAMESPACE . "SENDER_EMAIL", "abdau@pnc.ac.id"); // Sender email address
