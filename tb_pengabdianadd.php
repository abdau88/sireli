...
// Create page object
$tb_pengabdian_add = new tb_pengabdian_add();

// Run the page
$tb_pengabdian_add->run();
...
var ftb_pengabdianadd = currentForm = new ew.Form("ftb_pengabdianadd", "add");

// Validate form
ftb_pengabdianadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($tb_pengabdian_add->NIDN->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_pengabdian_add->anggota1->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_pengabdian_add->anggota2->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_pengabdian_add->anggota3->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_pengabdian_add->anggota4->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_pengabdian_add->judul->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_pengabdian_add->biaya->Required) { ?>
		...
		<?php if ($tb_pengabdian_add->tahun->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_pengabdian_add->LP2->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_pengabdian_add->LK->Required) { ?>
		...
		<?php } ?>
		<?php if ($tb_pengabdian_add->output->Required) { ?>
...
ftb_pengabdianadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftb_pengabdianadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftb_pengabdianadd.lists["x_NIDN"] = <?php echo $tb_pengabdian_add->NIDN->Lookup->toClientList() ?>;
ftb_pengabdianadd.lists["x_NIDN"].options = <?php echo JsonEncode($tb_pengabdian_add->NIDN->lookupOptions()) ?>;
ftb_pengabdianadd.autoSuggests["x_NIDN"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
ftb_pengabdianadd.lists["x_anggota1"] = <?php echo $tb_pengabdian_add->anggota1->Lookup->toClientList() ?>;
ftb_pengabdianadd.lists["x_anggota1"].options = <?php echo JsonEncode($tb_pengabdian_add->anggota1->lookupOptions()) ?>;
ftb_pengabdianadd.autoSuggests["x_anggota1"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
ftb_pengabdianadd.lists["x_anggota2"] = <?php echo $tb_pengabdian_add->anggota2->Lookup->toClientList() ?>;
ftb_pengabdianadd.lists["x_anggota2"].options = <?php echo JsonEncode($tb_pengabdian_add->anggota2->lookupOptions()) ?>;
ftb_pengabdianadd.autoSuggests["x_anggota2"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
ftb_pengabdianadd.lists["x_anggota3"] = <?php echo $tb_pengabdian_add->anggota3->Lookup->toClientList() ?>;
ftb_pengabdianadd.lists["x_anggota3"].options = <?php echo JsonEncode($tb_pengabdian_add->anggota3->lookupOptions()) ?>;
ftb_pengabdianadd.autoSuggests["x_anggota3"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
ftb_pengabdianadd.lists["x_anggota4"] = <?php echo $tb_pengabdian_add->anggota4->Lookup->toClientList() ?>;
ftb_pengabdianadd.lists["x_anggota4"].options = <?php echo JsonEncode($tb_pengabdian_add->anggota4->lookupOptions()) ?>;
ftb_pengabdianadd.autoSuggests["x_anggota4"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php $tb_pengabdian_add->showPageHeader(); ?>
<?php
$tb_pengabdian_add->showMessage();
?>
<form name="ftb_pengabdianadd" id="ftb_pengabdianadd" class="<?php echo $tb_pengabdian_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($tb_pengabdian_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $tb_pengabdian_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="tb_pengabdian">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$tb_pengabdian_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($tb_pengabdian->NIDN->Visible) { // NIDN ?>
	<div id="r_NIDN" class="form-group row">
		<label id="elh_tb_pengabdian_NIDN" class="<?php echo $tb_pengabdian_add->LeftColumnClass ?>"><?php echo $tb_pengabdian->NIDN->caption() ?><?php echo ($tb_pengabdian->NIDN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_pengabdian_add->RightColumnClass ?>"><div<?php echo $tb_pengabdian->NIDN->cellAttributes() ?>>
<?php if (!$Security->isAdmin() && $Security->isLoggedIn() && !$tb_pengabdian->userIDAllow("add")) { // Non system admin ?>
...
<script>
ftb_pengabdianadd.createAutoSuggest({"id":"x_NIDN","forceSelect":false});
</script>
...
<?php if ($tb_pengabdian->anggota1->Visible) { // anggota1 ?>
	<div id="r_anggota1" class="form-group row">
		<label id="elh_tb_pengabdian_anggota1" class="<?php echo $tb_pengabdian_add->LeftColumnClass ?>"><?php echo $tb_pengabdian->anggota1->caption() ?><?php echo ($tb_pengabdian->anggota1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_pengabdian_add->RightColumnClass ?>"><div<?php echo $tb_pengabdian->anggota1->cellAttributes() ?>>
...
<script>
ftb_pengabdianadd.createAutoSuggest({"id":"x_anggota1","forceSelect":false});
</script>
...
<?php if ($tb_pengabdian->anggota2->Visible) { // anggota2 ?>
	<div id="r_anggota2" class="form-group row">
		<label id="elh_tb_pengabdian_anggota2" class="<?php echo $tb_pengabdian_add->LeftColumnClass ?>"><?php echo $tb_pengabdian->anggota2->caption() ?><?php echo ($tb_pengabdian->anggota2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_pengabdian_add->RightColumnClass ?>"><div<?php echo $tb_pengabdian->anggota2->cellAttributes() ?>>
...
<script>
ftb_pengabdianadd.createAutoSuggest({"id":"x_anggota2","forceSelect":false});
</script>
...
<?php if ($tb_pengabdian->anggota3->Visible) { // anggota3 ?>
	<div id="r_anggota3" class="form-group row">
		<label id="elh_tb_pengabdian_anggota3" class="<?php echo $tb_pengabdian_add->LeftColumnClass ?>"><?php echo $tb_pengabdian->anggota3->caption() ?><?php echo ($tb_pengabdian->anggota3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_pengabdian_add->RightColumnClass ?>"><div<?php echo $tb_pengabdian->anggota3->cellAttributes() ?>>
...
<script>
ftb_pengabdianadd.createAutoSuggest({"id":"x_anggota3","forceSelect":false});
</script>
...
<?php if ($tb_pengabdian->anggota4->Visible) { // anggota4 ?>
	<div id="r_anggota4" class="form-group row">
		<label id="elh_tb_pengabdian_anggota4" class="<?php echo $tb_pengabdian_add->LeftColumnClass ?>"><?php echo $tb_pengabdian->anggota4->caption() ?><?php echo ($tb_pengabdian->anggota4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_pengabdian_add->RightColumnClass ?>"><div<?php echo $tb_pengabdian->anggota4->cellAttributes() ?>>
...
<script>
ftb_pengabdianadd.createAutoSuggest({"id":"x_anggota4","forceSelect":false});
</script>
...
<?php if ($tb_pengabdian->judul->Visible) { // judul ?>
	<div id="r_judul" class="form-group row">
		<label id="elh_tb_pengabdian_judul" for="x_judul" class="<?php echo $tb_pengabdian_add->LeftColumnClass ?>"><?php echo $tb_pengabdian->judul->caption() ?><?php echo ($tb_pengabdian->judul->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_pengabdian_add->RightColumnClass ?>"><div<?php echo $tb_pengabdian->judul->cellAttributes() ?>>
...
<?php if ($tb_pengabdian->biaya->Visible) { // biaya ?>
	<div id="r_biaya" class="form-group row">
		<label id="elh_tb_pengabdian_biaya" for="x_biaya" class="<?php echo $tb_pengabdian_add->LeftColumnClass ?>"><?php echo $tb_pengabdian->biaya->caption() ?><?php echo ($tb_pengabdian->biaya->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_pengabdian_add->RightColumnClass ?>"><div<?php echo $tb_pengabdian->biaya->cellAttributes() ?>>
...
<?php if ($tb_pengabdian->tahun->Visible) { // tahun ?>
	<div id="r_tahun" class="form-group row">
		<label id="elh_tb_pengabdian_tahun" for="x_tahun" class="<?php echo $tb_pengabdian_add->LeftColumnClass ?>"><?php echo $tb_pengabdian->tahun->caption() ?><?php echo ($tb_pengabdian->tahun->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_pengabdian_add->RightColumnClass ?>"><div<?php echo $tb_pengabdian->tahun->cellAttributes() ?>>
...
<?php if ($tb_pengabdian->LP2->Visible) { // LP2 ?>
	<div id="r_LP2" class="form-group row">
		<label id="elh_tb_pengabdian_LP2" class="<?php echo $tb_pengabdian_add->LeftColumnClass ?>"><?php echo $tb_pengabdian->LP2->caption() ?><?php echo ($tb_pengabdian->LP2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_pengabdian_add->RightColumnClass ?>"><div<?php echo $tb_pengabdian->LP2->cellAttributes() ?>>
...
<?php if ($tb_pengabdian->LK->Visible) { // LK ?>
	<div id="r_LK" class="form-group row">
		<label id="elh_tb_pengabdian_LK" class="<?php echo $tb_pengabdian_add->LeftColumnClass ?>"><?php echo $tb_pengabdian->LK->caption() ?><?php echo ($tb_pengabdian->LK->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_pengabdian_add->RightColumnClass ?>"><div<?php echo $tb_pengabdian->LK->cellAttributes() ?>>
...
<?php if ($tb_pengabdian->output->Visible) { // output ?>
	<div id="r_output" class="form-group row">
		<label id="elh_tb_pengabdian_output" class="<?php echo $tb_pengabdian_add->LeftColumnClass ?>"><?php echo $tb_pengabdian->output->caption() ?><?php echo ($tb_pengabdian->output->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $tb_pengabdian_add->RightColumnClass ?>"><div<?php echo $tb_pengabdian->output->cellAttributes() ?>>
...
<?php if (!$tb_pengabdian_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $tb_pengabdian_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $tb_pengabdian_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$tb_pengabdian_add->showPageFooter();
if (DEBUG_ENABLED)
